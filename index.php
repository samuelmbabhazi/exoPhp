...
<body>
    <div class="flex justify-center flex-col items-center p-16 gap-6">
        ...
        <a href="views/create.php" role="button"
            class='focus:outline-none text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900'>Nouveau</a>
        <br>
        <table class="min-w-full text-left text-sm font-light">
            ...
            <tbody class="bg-[white] rounded-md p-20 shadow-md">
                ...
                include './employes/employes.repository.php';
                ...
                <tr class='border-b dark:border-neutral-500'>
                    ...
                    <td class='flex'>
                        <a href='views/edit.php?id=<?= $row[id]?>'
                            class='focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900'>EDIT</a>
